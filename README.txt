...
Read the experimental instructions verbatim and demonstrate the poses accordingly. Show the participant the head mounted display (HMD).
...
Press R to center them in the virtual space.
